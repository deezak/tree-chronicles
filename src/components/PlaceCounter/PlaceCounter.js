  ...
  return (
    <div className="place" >
      <div className= "flex-across-counter">
        ...
        {(isMobile || isTablet) && <h1 className='placecounter-label'>Countries Visited:</h1>} 
          <p className='placecounter-number'>{countryCount}</p>
          {/* <br/> */}
        </div>
        <div className="counter-unit">
        {isDesktop && <h1 className='placecounter-label'>Cities Visited:</h1>}
        {(isMobile || isTablet) && <h1 className='placecounter-label'>Cities Visited:</h1>} 
      ...
      <div className= "flex-across-counter">
        ...
        {(isMobile || isTablet) && <h1 className='placecounter-label'>Days on the Road:</h1>} 
            <p className='placecounter-number'>453</p>
        </div> 
        <div className="counter-unit">
          {isDesktop && <h1 className='placecounter-label'>Current Country:</h1>}
        {(isMobile || isTablet) && <h1 className='placecounter-label'>Current  Country:</h1>} 
